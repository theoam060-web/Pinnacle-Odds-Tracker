...
const T: Record<LangCode, Translations> = {
  ...
  da: {
    nav: {
      ...
      pricing: "Priser",
      faq: "FAQ",
      login: "Log ind med Google",
      signup: "Log ind med Google",
  ...
  fr: {
    nav: {
      ...
      signup: "Se connecter avec Google",
  ...
  es: {
    nav: {
      ...
      signup: "Iniciar sesión con Google",
  ...
  pl: {
    nav: {
      ...
      signup: "Zaloguj się przez Google",
